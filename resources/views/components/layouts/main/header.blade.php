            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100"
                ...
                <div class="py-1">
                    <a href="{{ route('profile.edit', ['tab' => 'profile']) }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors {{ request()->routeIs('profile.edit') && request('tab', 'profile') === 'profile' ? 'bg-blue-50 text-blue-600 font-semibold' : '' }}"
                        >
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('profile.edit', ['tab' => 'security']) }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors {{ request()->routeIs('profile.edit') && request('tab') === 'security' ? 'bg-blue-50 text-blue-600 font-semibold' : '' }}">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
