<div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
                    ...
                    <span class="font-medium text-blue-600">{{ $type->name }}</span>
                </div>
                        ...
                        <tr class="hover:bg-blue-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('master.type.service.detail', ['type_id' => $type->id, 'service_id' => $service->id]) }}"
    ...
    @include('livewire.admin.master.type.service.admin-master-type-service-modal')
