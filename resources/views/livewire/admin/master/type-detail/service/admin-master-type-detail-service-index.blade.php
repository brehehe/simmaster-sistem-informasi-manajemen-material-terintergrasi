<div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
                    ...
                    <span class="font-medium text-blue-600">{{ $typeDetail->type->name }} - {{ $typeDetail->name }}</span>
                </div>
                <h1 class="text-3xl font-bold text-blue-600">Manajemen Service</h1>
                <p class="text-gray-500 mt-1">Kelola data service untuk tipe detail {{ $typeDetail->name }}</p>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                        ...
                        <tr class="hover:bg-blue-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <button wire:click="openDetail('{{ $service->id }}')"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="p-10 text-center">
                                <p class="text-gray-500">Tidak ada data service</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
            ...
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div class="text-sm text-gray-600">
                        Menampilkan <span class="font-semibold">{{ $services->firstItem() }}</span>
                        sampai <span class="font-semibold">{{ $services->lastItem() }}</span>
                        dari <span class="font-semibold">{{ $services->total() }}</span> hasil
                    </div>
        ...
        @else
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                <div class="text-sm text-gray-600">
                    Menampilkan <span class="font-semibold">{{ $services->count() }}</span> hasil
                </div>
            </div>
        @endif
    </div>

    @include('livewire.admin.master.type-detail.service.admin-master-type-detail-service-modal')
