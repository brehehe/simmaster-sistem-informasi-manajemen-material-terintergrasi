    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 mt-1">Buat stock opname baru untuk Polda atau Polres</p>
            </div>
            <div>
        ...
        <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-6 mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-semibold text-gray-700 mb-3">Tipe Owner <span
                            class="text-red-500">*</span></label>
                    <div class="flex gap-4">
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" wire:model.live="ownerType" value="polda"
                                class="w-4 h-4 text-blue-600 focus:ring-blue-500">
                            <span class="ml-2 text-sm font-medium text-gray-700">Polda</span>
                        </label>
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" wire:model.live="ownerType" value="polres"
                                class="w-4 h-4 text-blue-600 focus:ring-blue-500">
                            <span class="ml-2 text-sm font-medium text-gray-700">Polres</span>
                        </label>
                    </div>
                    @error('ownerType')
                ...
                @if ($ownerType === 'polda')
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Polda <span
                                class="text-red-500">*</span></label>
                ...
                @if ($ownerType === 'polres')
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Polres <span
                                class="text-red-500">*</span></label>
                        <select wire:model.live="police_station_id"
                            class="w-full px-3 py-2 text-sm rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-xs text-gray-500 mt-2">Klik untuk memuat semua stock dari lokasi yang dipilih</p>
                </div>
            </div>
        </div>
