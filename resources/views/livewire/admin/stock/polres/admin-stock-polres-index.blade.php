<div>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-blue-600">Stock Polres</h1>
                <p class="text-gray-500 mt-1">Daftar stock material di level Polres</p>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            <td colspan="7" class="p-10 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">Belum ada stock material di level Polres</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
