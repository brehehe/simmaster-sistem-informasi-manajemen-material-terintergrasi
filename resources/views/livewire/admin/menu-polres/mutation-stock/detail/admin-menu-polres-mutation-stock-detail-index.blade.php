        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    <a href="{{ route('menu-polres.mutation-stock') }}" wire:navigate
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden mb-6">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Kode Mutasi -->
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Kode Mutasi</label>
                ...
                <div class="md:col-span-2 p-4 rounded-xl bg-green-50 border border-green-200">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Penerima</h3>
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden mb-6">
        <div class="p-6 border-b border-gray-100 bg-gradient-to-r from-orange-50 to-amber-50/50">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-gray-800">Detail Stock</h2>
            ...
            @if (count($details) > 0)
                <div class="space-y-4">
                    @foreach ($details as $index => $detail)
                        <div class="relative p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50/50 border-2 border-gray-100 shadow-md hover:shadow-lg transition-all duration-300">
                            <!-- Item Number Badge -->
                            <div class="absolute -top-3 -left-3 w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 text-white font-bold flex items-center justify-center shadow-lg">
                                {{ $index + 1 }}
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <!-- Stock Selection -->
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Pilih Stock</label>
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Quantity (Max: {{ $detail['available_quantity'] }})</label>
