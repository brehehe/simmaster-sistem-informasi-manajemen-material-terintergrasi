<div>
    ...
    <div class="mb-4">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-blue-600">Material Rusak/Hilang</h1>
                <p class="text-gray-500 mt-1">Kelola material yang rusak atau hilang dengan tracking pengurangan stock
                </p>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('menu-polres.material-damage.edit', $damage->id) }}" wire:navigate
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-400 text-sm mt-1">Silakan tambahkan data material rusak/hilang</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Hapus Data Material Rusak/Hilang</h3>
