                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                            ...
                                            readonly
                                            class="w-full px-4 py-2.5 text-sm rounded-lg border border-gray-200 bg-gray-50 text-gray-600 cursor-not-allowed">
                                    </div>

                                    <!-- To Rack -->
                                    <div>
                                        <label class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                            To Rack <span class="text-red-500">*</span>
                                        </label>
                                        <select wire:model="details.{{ $index }}.to_rack_id" {{ $isEditMode ? 'disabled' : '' }}
                                            class="w-full px-4 py-2.5 text-sm rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 bg-white transition-all duration-200 {{ $isEditMode ? 'bg-gray-100 text-gray-500 cursor-not-allowed' : '' }}">
