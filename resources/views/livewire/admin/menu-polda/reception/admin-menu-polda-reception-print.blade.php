<div>
    ...
    <div class="sppm-title">
        <h2>SURAT PERINTAH PENERIMAAN MATERIEL</h2>
        <p>Nomor : SPPM/{{ $reception->code }}/LOG.3.6.7./{{ date('Y') }}</p>
    </div>
    ...
    <table class="info-table">
        <tr>
            ...
            <td>:</td>
            <td>{{ \Carbon\Carbon::parse($reception->date)->translatedFormat('d F Y') }}</td>
        </tr>
        <tr>
            <td>Diserahkan kepada</td>
            <td>:</td>
            <td>{{ strtoupper($reception?->policeStation?->name ?? 'DITLANTAS POLDA JATIM') }}</td>
        </tr>
        <tr>
            <td>Berdasarkan SPPM</td>
            <td>:</td>
            <td>Nomor SPPM/{{ $reception->code }}/KORLANTAS Tgl {{ \Carbon\Carbon::parse($reception->date)->translatedFormat('d-m-Y') }}</td>
        </tr>
        <tr>
            <td>Material</td>
            <td>:</td>
            <td>{{ $reception->typeMaterial?->name ?? '-' }}</td>
        </tr>
    </table>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="7" style="text-align: center; height: 100px;">Tidak ada detail penerimaan.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="signatures">
        <table>
            <tr>
                <td></td>
                <td>
                    <div style="margin-bottom: 5px;">Surabaya, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ \Carbon\Carbon::parse($reception->date)->translatedFormat('F Y') }}</div>
    ...
    <div class="receiver-info">
        ...
        <table style="width: auto;">
            ...
            <tr>
                <td>Tanda Tangan</td>
                <td>:</td>
                <td style="height: 40px; vertical-align: bottom;">__________________________</td>
            </tr>
        </table>
    </div>
