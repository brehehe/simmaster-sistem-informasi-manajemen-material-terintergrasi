<div>
    ...
    <div class="mb-4">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('menu-polda.last-stock.create') }}" wire:navigate
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                        ...
                        <tr class="hover:bg-blue-50/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('menu-polda.last-stock.edit', $lastStock->id) }}" wire:navigate
        ...
        <!-- Pagination Footer -->
        @if ($lastStocks->hasPages())
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <!-- Info Text -->
                    <div class="text-sm text-gray-600">
                        Menampilkan <span class="font-semibold">{{ $lastStocks->firstItem() }}</span>
                        sampai <span class="font-semibold">{{ $lastStocks->lastItem() }}</span>
                        dari <span class="font-semibold">{{ $lastStocks->total() }}</span> hasil
                    </div>

                    <!-- Pagination Numbers -->
                    <div class="flex items-center gap-1">
                        {{-- Previous Button --}}
                        @if ($lastStocks->onFirstPage())
                        ...
                        {{-- Page Numbers --}}
                        @php
                            $currentPage = $lastStocks->currentPage();
                            $lastPage = $lastStocks->lastPage();
        ...
        @else
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                <div class="text-sm text-gray-600">
                    Menampilkan <span class="font-semibold">{{ $lastStocks->count() }}</span> hasil
                </div>
            </div>
        @endif
    </div>
