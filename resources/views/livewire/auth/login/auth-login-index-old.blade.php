<div class="min-h-screen flex">
    ...
    <div
        ...
        <div class="relative z-10 flex flex-col justify-center items-center w-full p-12">
            ...
            <div class="mb-8">
                <div
                    class="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 to-blue-500 shadow-2xl shadow-cyan-500/30">
            ...
            <!-- Title -->
            <h1 class="text-4xl font-bold text-white mb-4 text-center">SBST</h1>
            <p class="text-xl text-blue-200 mb-8 text-center">Sistem Distribusi Material</p>

            <!-- Illustration - Traffic/Distribution (Parallax Effect) -->
            <div class="relative w-full max-w-md overflow-hidden" x-data="{ light: 'green' }" x-init="setInterval(() => {
                ...
                <svg class="w-full h-auto" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g class="scroll-bg" style="animation-delay: 0s;">
                        <rect x="50" y="80" width="30" height="80" rx="8" fill="#1e3a5f" />
                        <circle cx="65" cy="100" r="10"
                            :fill="light === 'green' ? '#22c55e' : '#1e3a5f'"
                            :class="light === 'green' ? 'drop-shadow-[0_0_8px_#22c55e]' : ''"
                            class="transition-all duration-300" />
                        <circle cx="65" cy="125" r="10"
                            :fill="light === 'yellow' ? '#fbbf24' : '#1e3a5f'"
                            :class="light === 'yellow' ? 'drop-shadow-[0_0_8px_#fbbf24]' : ''"
                            class="transition-all duration-300" />
                        <circle cx="65" cy="150" r="10"
                            :fill="light === 'red' ? '#ef4444' : '#1e3a5f'"
                            :class="light === 'red' ? 'drop-shadow-[0_0_8px_#ef4444]' : ''"
                            class="transition-all duration-300" />
                        <rect x="62" y="160" width="6" height="40" fill="#1e3a5f" />
                    </g>

                    <!-- Traffic Light 2 (offset) -->
                    <g class="scroll-bg" style="animation-delay: -4s;">
                        <rect x="50" y="80" width="30" height="80" rx="8" fill="#1e3a5f" />
                        <circle cx="65" cy="100" r="10"
                            :fill="light === 'green' ? '#22c55e' : '#1e3a5f'" class="transition-all duration-300" />
                        <circle cx="65" cy="125" r="10"
                            :fill="light === 'yellow' ? '#fbbf24' : '#1e3a5f'" class="transition-all duration-300" />
                        <circle cx="65" cy="150" r="10"
                            :fill="light === 'red' ? '#ef4444' : '#1e3a5f'" class="transition-all duration-300" />
                        <rect x="62" y="160" width="6" height="40" fill="#1e3a5f" />
                    </g>
                    ...
                    <g class="scroll-bg" style="animation-delay: -6s;">
                        <rect x="320" y="120" width="40" height="80" fill="#1e3a5f" />
                        <rect x="328" y="130" width="10" height="12" fill="#7dd3fc" />
                        <rect x="342" y="130" width="10" height="12" fill="#7dd3fc" />
                        <rect x="328" y="150" width="10" height="12" fill="#7dd3fc" />
                        <rect x="342" y="150" width="10" height="12" fill="#7dd3fc" />
                        <rect x="335" y="180" width="12" height="20" fill="#0ea5e9" />
                        <text x="340" y="115" font-size="7" fill="#7dd3fc" text-anchor="middle">POLRES</text>
                    </g>

                    <!-- Tree 1 -->
                    <g class="scroll-bg" style="animation-delay: -3s;">
                        <rect x="180" y="160" width="8" height="40" fill="#854d0e" />
                        <circle cx="184" cy="145" r="20" fill="#166534" />
                    </g>

                    <!-- Tree 2 -->
                    <g class="scroll-bg" style="animation-delay: -7s;">
                        <rect x="180" y="160" width="8" height="40" fill="#854d0e" />
                        <circle cx="184" cy="145" r="20" fill="#166534" />
                    </g>
            ...
            <!-- Stats -->
            <div class="grid grid-cols-3 gap-8 mt-12 w-full max-w-md">
                <div class="text-center">
                    <div class="text-3xl font-bold text-white">34</div>
                    <div class="text-sm text-blue-300">Polda</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-white">500+</div>
                    <div class="text-sm text-blue-300">Polres</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-white">24/7</div>
                    <div class="text-sm text-blue-300">Monitoring</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-slate-50 to-blue-50">
        <div class="w-full max-w-md">
            ...
            <div class="lg:hidden flex flex-col items-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-blue-900">SBST</h1>
                <p class="text-sm text-blue-600">Sistem Distribusi Material</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input wire:model="email" type="email" id="email" placeholder="nama@email.com"
                            class="w-full pl-12 pr-4 py-3.5 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 @error('email') border-red-500 @enderror">
                    </div>
                    @error('email')
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        ...
                        <input wire:model="password" :type="show ? 'text' : 'password'" id="password"
                            placeholder="••••••••"
                            class="w-full pl-12 pr-12 py-3.5 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 @error('password') border-red-500 @enderror">
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-500">
                    &copy; {{ date('Y') }} SBST - Sistem Distribusi Material
                </p>
