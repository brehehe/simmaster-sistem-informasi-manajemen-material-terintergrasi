...
class AdminStockOpnameCreate extends Component
{
    ...
    public function save()
    {
        ...
        try {
            ...
            \App\Actions\MenuPolda\CreateStockOpnameAction::run(
                $headerData,
                $this->stockDetails
            );
    ...
    public function render()
    {
        ...
        return view('livewire.admin.stock-opname.admin-stock-opname-create', [
