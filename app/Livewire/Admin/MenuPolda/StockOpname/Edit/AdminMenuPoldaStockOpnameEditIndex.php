...
namespace App\Livewire\Admin\MenuPolda\StockOpname\Edit;
...
class AdminMenuPoldaStockOpnameEditIndex extends Component
{
    ...
    {
        return view('livewire.admin.menu-polda.stock-opname.edit.admin-menu-polda-stock-opname-edit-index')
