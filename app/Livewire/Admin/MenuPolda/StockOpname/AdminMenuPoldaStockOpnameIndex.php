...
namespace App\Livewire\Admin\MenuPolda\StockOpname;

use App\Models\StockOpname\StockOpname;
use Livewire\Component;
use Livewire\WithPagination;

class AdminMenuPoldaStockOpnameIndex extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.menu-polda.stock-opname.admin-menu-polda-stock-opname-index', [
            'opnames' => $opnames,
