...
namespace App\Livewire\Admin\MenuPolda\LastStock\Detail;
...
class AdminMenuPoldaLastStockDetailIndex extends Component
{
    // Mode
    ...
    public function mount($id = null)
    {
        ...
        if ($this->isEditMode) {
            ...
            $this->regionalPoliceId = $lastStock->regional_police_id;
    ...
    protected function rules()
    {
        ...
        if (!$user->hasRole('Polda')) {
            $rules['regionalPoliceId'] = 'nullable|exists:regional_police,id';
        }
    ...
    public function save()
    {
        ...
        try {
            ...
            return $this->redirect(route('menu-polda.last-stock'), navigate: true);
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function render()
    {
        ...
        return view('livewire.admin.menu-polda.last-stock.detail.admin-menu-polda-last-stock-detail-index', [
