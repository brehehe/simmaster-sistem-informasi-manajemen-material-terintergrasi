...
namespace App\Livewire\Admin\MenuPolda\RackAssignment\Detail;
...
class AdminMenuPoldaRackAssignmentDetailIndex extends Component
{
    ...
    protected function loadRackAssignment()
    {
        ...
        $this->regionalPoliceId = $rackAssignment->regional_police_id;
    ...
    {
        return view('livewire.admin.menu-polda.rack-assignment.detail.admin-menu-polda-rack-assignment-detail-index')
