...
namespace App\Livewire\Admin\MenuPolda\Stock;
...
class AdminMenuPoldaStockIndex extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        if ($this->filterRegionalPoliceId) {
            $query->where('regional_police_id', $this->filterRegionalPoliceId);
        }
        ...
        return view('livewire.admin.menu-polda.stock.admin-menu-polda-stock-index', [
            'stocks' => $stocks,
            'types' => $types,
