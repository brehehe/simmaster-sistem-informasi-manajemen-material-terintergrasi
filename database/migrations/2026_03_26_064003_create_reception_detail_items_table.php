...
return new class extends Migration
{
    ...
    {
        Schema::create('reception_detail_items', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->foreignUuid('reception_id');
            $table->foreignUuid('reception_detail_id');
            $table->foreignUuid('service_id')->nullable();
            $table->foreignUuid('service_detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('reception_detail_items');
    }
};
