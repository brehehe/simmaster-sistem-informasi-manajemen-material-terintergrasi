<div>
    ...
    <div class="mb-4">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-blue-600">Masukkan Ke Rak</h1>
                <p class="text-gray-500 mt-1">Kelola perpindahan material ke/antar rak</p>
            </div>
            <a href="<?php echo e(route('menu-polres.rack-assignment.create')); ?>" 
                        ...
                        <select id="select-police-station" x-data x-init="
                            const selectize = $($el).selectize({
                                ...
                                onChange: function(val) {
                                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('policeStationId', val);
                                }
                            })[0].selectize;
                        "
                ...
                <div wire:ignore>
                    <select id="select-type" x-data x-init="
                        const selectize = $($el).selectize({
                            ...
                            plugins: ['clear_button'],
                            onChange: function(val) {
                                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('typeId', val);
                            }
                        })[0].selectize;
                    "
                ...
                <div wire:ignore wire:key="select-type-detail-wrapper-<?php echo e($typeId); ?>">
                    <select id="select-type-detail-<?php echo e($typeId); ?>" x-data x-init="
                        const selectize = $($el).selectize({
                            ...
                            plugins: ['clear_button'],
                            onChange: function(val) {
                                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('typeDetailId', val);
                            }
                        })[0].selectize;
                    "
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rackAssignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-6 py-4 text-sm text-gray-600 whitespace-nowrap">
                                <?php echo e($rackAssignments->firstItem() + $index); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-medium text-blue-600"><?php echo e($assignment->rackAssignment->code ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600 whitespace-nowrap">
                                <?php echo e(\Carbon\Carbon::parse($assignment->rackAssignment->date)->format('d M Y')); ?>

                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600 whitespace-nowrap">
                                <?php echo e($assignment->type->name ?? '-'); ?>

                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600 whitespace-nowrap">
                                <?php echo e($assignment->typeDetail->name ?? '-'); ?>

                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600 whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assignment->item_code): ?>
                                    <?php echo e($assignment->item_code); ?>

                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php echo e($assignment->number_serial_first); ?>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assignment->number_serial_second): ?>
                                    <?php echo e($assignment->number_serial_second); ?>

                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap">
                                <?php echo e(number_format($assignment->quantity, 0)); ?>

                            </td>
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap">
                                <?php echo e($assignment->rackAssignment->policeStation->name ?? ($assignment->rackAssignment->regionalPolice->name ?? '-')); ?>

                            </td>
                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('menu-polres.rack-assignment.edit', $assignment->rack_assignment_id)); ?>"
                                    ...
                                    <button wire:click="openDeleteModal('<?php echo e($assignment->rack_assignment_id); ?>')"
                        ...
                        <tr>
                            <td colspan="8" class="p-10 text-center whitespace-nowrap">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-500 text-lg font-medium">Tidak ada data rack assignment</p>
        ...
        <!-- Pagination -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rackAssignments->hasPages()): ?>
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <!-- Info Text -->
                    <div class="text-sm text-gray-600">
                        Menampilkan <span class="font-semibold"><?php echo e($rackAssignments->firstItem()); ?></span>
                        sampai <span class="font-semibold"><?php echo e($rackAssignments->lastItem()); ?></span>
                        dari <span class="font-semibold"><?php echo e($rackAssignments->total()); ?></span> hasil
                    </div>

                    <!-- Pagination Numbers -->
                    <div class="flex items-center gap-1">
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rackAssignments->onFirstPage()): ?>
                        ...
                        <?php
                            $currentPage = $rackAssignments->currentPage();
                            $lastPage = $rackAssignments->lastPage();
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rackAssignments->hasMorePages()): ?>
        ...
        <?php else: ?>
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                <div class="text-sm text-gray-600">
                    Menampilkan <span class="font-semibold"><?php echo e($rackAssignments->count()); ?></span> hasil
                </div>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Hapus Data Rack Assignment</h3>
...
<?php /**PATH /var/www/html/armaster/resources/views/livewire/admin/menu-polres/rack-assignment/admin-menu-polres-rack-assignment-index.blade.php ENDPATH**/ ?>