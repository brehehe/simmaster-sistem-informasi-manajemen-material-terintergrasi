...
[$__name, $__params] = $__split('actions.notification-bell');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2393174652-0', null);
        ...
        <div class="relative" x-data="{ open: false }">
            <button @click="open = !open"
                ...
                <div class="hidden lg:block text-left">
                    ...
                    <p class="text-xs text-gray-500"><?php echo e(auth()->user()->roles->pluck('name')->first() ?? 'User'); ?></p>
                </div>
...
[$__name, $__params] = $__split('auth.logout.auth-logout-index');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2393174652-1', null);
...
<?php /**PATH /var/www/html/armaster/resources/views/components/layouts/main/header.blade.php ENDPATH**/ ?>