<div class="h-screen flex overflow-hidden">
    ...
    <div
        ...
        <div class="relative z-10 flex flex-col justify-center items-center w-full h-full p-8">
            <!-- Logo -->
            <div class="mb-6">
                <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo" class="w-24">
            </div>

            <!-- Title -->
            <h1 class="text-3xl font-bold text-white mb-3 text-center">ARMASTER</h1>
            <p class="text-base text-blue-200 mb-6 text-center max-w-md">Smart Fasmat SBST Terintegrasi</p>
                ...
                <svg class="w-full h-auto" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g class="truck-bounce">
                        ...
                        <g>
                            ...
                            <line x1="145" y1="192" x2="145" y2="208" stroke="#64748b" stroke-width="3"
                                class="wheel-spin" style="transform-origin: 145px 200px;" />
                            <line x1="137" y1="200" x2="153" y2="200" stroke="#64748b" stroke-width="3"
                                class="wheel-spin" style="transform-origin: 145px 200px;" />

                            <!-- Back Wheel 2 -->
                            <circle cx="195" cy="200" r="15" fill="#1e3a5f" />
                            <circle cx="195" cy="200" r="8" fill="#475569" />
                            <line x1="195" y1="192" x2="195" y2="208" stroke="#64748b" stroke-width="3"
                                class="wheel-spin" style="transform-origin: 195px 200px;" />
                            <line x1="187" y1="200" x2="203" y2="200" stroke="#64748b" stroke-width="3"
                                class="wheel-spin" style="transform-origin: 195px 200px;" />

                            <!-- Front Wheel -->
                            <circle cx="240" cy="200" r="15" fill="#1e3a5f" />
                            <circle cx="240" cy="200" r="8" fill="#475569" />
                            <line x1="240" y1="192" x2="240" y2="208" stroke="#64748b" stroke-width="3"
                                class="wheel-spin" style="transform-origin: 240px 200px;" />
                            <line x1="232" y1="200" x2="248" y2="200" stroke="#64748b" stroke-width="3"
                                class="wheel-spin" style="transform-origin: 240px 200px;" />
                        </g>
                    </g>
                </svg>
    ...
    <div
        ...
        <div class="w-full max-w-md">
            ...
            <div class="hidden lg:flex justify-center mb-3">
                <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo" class="w-20">
            </div>
            <!-- Welcome Text -->
            <div class="mb-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input wire:model="email" type="email" id="email" placeholder="nama@email.com"
                            class="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 <?php $__errorArgs = ['email'];
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        ...
                        <input wire:model="password" :type="show ? 'text' : 'password'" id="password"
                            placeholder="••••••••"
                            class="w-full pl-12 pr-12 py-3 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mt-5 text-center">
                <p class="text-sm text-gray-500">
                    &#64;<?php echo e(date('Y')); ?> Smart Fasmat Terintegrasi
                </p>
                
            </div>
        </div>
    </div>
</div><?php /**PATH /var/www/html/armaster/resources/views/livewire/auth/login/auth-login-index.blade.php ENDPATH**/ ?>