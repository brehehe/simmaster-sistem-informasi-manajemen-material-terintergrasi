<div x-data="{
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $materialShipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $shipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-6 py-4 text-sm text-gray-500 text-center">
                                <?php echo e($materialShipments->firstItem() + $index); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-bold font-mono text-blue-600"><?php echo e($shipment->code); ?></span>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700 whitespace-nowrap">
                                <?php echo e($shipment->shipment_date ? \Carbon\Carbon::parse($shipment->shipment_date)->format('d M Y') : ($shipment->shipped_at ? \Carbon\Carbon::parse($shipment->shipped_at)->format('d M Y') : '-')); ?>

                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700 whitespace-nowrap">
                                <?php echo e($shipment->shipped_at ? \Carbon\Carbon::parse($shipment->shipped_at)->format('H:i') : ($shipment->created_at ? \Carbon\Carbon::parse($shipment->created_at)->format('H:i') : '-')); ?> WIB
                            </td>
                            ...
                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shipment->status === 'shipped' || $shipment->status === 'sent'): ?>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900 font-semibold whitespace-nowrap">
                                <?php echo e($shipment->receiverPoliceStation->name ?? '-'); ?>

                            </td>
                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                <a  href="<?php echo e(route('menu-polres.material-shipment.receive.detail', ['id' => $shipment->id])); ?>"
        ...
        <div class="px-6 py-4 border-t border-gray-100 bg-gray-50">
            <?php echo e($materialShipments->links()); ?>
...
<?php /**PATH /var/www/html/armaster/resources/views/livewire/polres/menu-polres/material-shipment/polres-menu-polres-material-shipment-receive-index.blade.php ENDPATH**/ ?>