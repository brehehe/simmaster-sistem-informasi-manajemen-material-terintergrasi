...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <title><?php echo e($title ?? 'ARMASTER'); ?> - Sistem Informasi Manajemen Material SBST Terintegrasi</title>
    ...
    <body class="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50 font-sans antialiased"
        ...
        <!-- Sidebar -->
        <?php echo $__env->make('components.layouts.main.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <!-- Top Header (Fixed outside main content) -->
        <?php echo $__env->make('components.layouts.main.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH /var/www/html/armaster/resources/views/components/layouts/main/app.blade.php ENDPATH**/ ?>